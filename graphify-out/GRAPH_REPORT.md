# Graph Report - kouen-terminal  (2026-08-09)

## Corpus Check
- 854 files · ~880,744 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15447 nodes · 35632 edges · 3159 communities (972 shown, 2187 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 3985 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ee63244b`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## God Nodes (most connected - your core abstractions)
1. `SurfaceRegistry` - 195 edges
2. `IPCRequest` - 190 edges
...
1. `IPCRequest` - bridges 172 areas (190 edges)
2. `Command` - bridges 101 areas (107 edges)
3. `IPCResponse` - bridges 73 areas (94 edges)
4. `SessionCoordinator` - bridges 60 areas (131 edges)
5. `SurfaceRegistry` - bridges 59 areas (195 edges)
6. `MenuTarget` - bridges 57 areas (68 edges)
7. `KouenPaths` - bridges 55 areas (121 edges)
8. `AgentKind` - bridges 53 areas (108 edges)
...
## Communities (3159 total, 2187 thin omitted)
...
Cohesion: 0.09
Nodes (18): DaemonClient, ClaudeCodeHarnessIPCTests, String, URL, ConcurrentIndexSet, DaemonContentionTests, String, URL (+10 more)

### Community 5 - "IPCRequest"
Cohesion: 0.09
Nodes (21): header, DecodedReplyFrame, output, reply, DecodedRequestFrame, input, request, FrameError (+13 more)
...
Cohesion: 0.12
Nodes (10): .addSurface(tabID:paneID:), .tab(containingPaneID:), .tab(forSurfaceKey:), .tabIndex(surfaceKey:), .tabIndex(workspaceID:tabID:), Bool, Date, String (+2 more)
...
Cohesion: 0.13
Nodes (8): SessionCoordinator, Bool, Double, SessionID, SplitDirection, String, TabID, WorkspaceID
...
Cohesion: 0.11
Nodes (14): Bool, Data, String, UInt8, UnsafeBufferPointer, TerminalEmulator, .captureLines(fromLine:toLine:), .captureLines(joinWrapped:) (+6 more)
...
Cohesion: 0.18
Nodes (10): NWEndpoint, NWListener, ConnectionState, ErrorAck, MobileBridgeServer, Data, NWConnection, T (+2 more)
...
Cohesion: 0.14
Nodes (10): Process, SSHTunnelManager, .init(makeTunnelProcess:reachabilityProbe:), RemoteHost, URL, Tunnel, SSHTunnelManagerTests, RemoteHost (+2 more)
...
Cohesion: 0.06
Nodes (31): ISO8601DateFormatter, KouenTask, Bool, Date, SessionID, String, URL, UUID (+23 more)

### Community 58 - "PasteBufferStore"
Cohesion: 0.11
Nodes (33): MTLClearColor, MTLCommandBuffer, MTLRenderCommandEncoder, BgInstance, CursorCacheKey, DecoInstance, EncodedFrameInstances, EncodedRowInstances (+25 more)
...
### Community 64 - ".text"
Cohesion: 0.19
Nodes (9): KouenCLI, String, KouenCLI, SessionGroup, SessionSnapshot, String, UUID, T (+1 more)
...
Cohesion: 0.06
Nodes (25): CornerInfo, EditorDividerView, KouenSplitView, .init(coder:), PaneDragGripView, .init(coder:), PaneHoverButton, PaneSplitButtonsView (+17 more)
...
Cohesion: 0.13
Nodes (24): TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate, vivid, .init(themeName:fontFamily:fontSize:vivid:colorRendering:colorGamut:offMainParserFramePipeline:liveResizeReflow:) (+16 more)
...
Cohesion: 0.10
Nodes (22): FilePreviewCoordinator, FileTabID, NSView, Set, SplitDirection, String, FileEditorTabBarBody, FileEditorTabBarModel (+14 more)
...
Cohesion: 0.11
Nodes (18): KouenIPC, CommandIPCTranslator, CommandTarget, CommandTranslation, clientLocal, requests, unresolved, Command (+10 more)
...
Cohesion: 0.14
Nodes (10): DecodedWSFrame, PairingBox, PendingPairing, Bool, Date, TimeInterval, WSFrameParseResult, frame (+2 more)
...
Cohesion: 0.11
Nodes (14): Bool, String, UUID, TaskDaemonBridge, String, TaskDashboardBody, TaskRowView, Bool (+6 more)
...
Cohesion: 0.10
Nodes (8): tab, .tab(for:), FormatContextDaemonTests, PaneID, SessionSnapshot, String, SurfaceID, URL
...
Cohesion: 0.07
Nodes (35): AgentStatusDot, Context, .init(entry:), AgentChipView, BoardColumnKind, ChromeRole, sidebar, tabBar (+27 more)
...
Cohesion: 0.12
Nodes (5): KouenDaemonTools, .init(client:subscriptionClient:controlEnabled:), SessionSnapshot, String, UUID
...
### Community 186 - "Error"
Cohesion: 0.08
Nodes (33): Int, TerminalGridSnapshot, .readGrid(scrollbackOffset:), ImagePlacementSnapshot, SemanticMark, Bool, String, UInt8 (+25 more)
...
Cohesion: 0.08
Nodes (38): BlockSelection, CursorRender, CursorStyle, bar, block, underline, FrameBuilder, .build(_:region:searchHighlights:copyModeCursor:imageProvider:reusing:damage:) (+30 more)
...
Cohesion: 0.09
Nodes (21): DaemonSyncService, .logIfFailed(_:), .request(_:), .sync(metadataOnly:), Bool, Never, PaneID, SessionCoordinator (+13 more)
...
Cohesion: 0.11
Nodes (11): DaemonClientActor, TimeInterval, daemonError, DaemonSessionService, .request(_:timeout:), Bool, SessionSnapshot, TimeInterval (+3 more)
...
Cohesion: 0.13
Nodes (19): .init(from:), Decoder, CodingKeys, activeSessionID, activeTabID, id, name, sessions (+11 more)

### Community 259 - "ThemeFileServiceTests"
Cohesion: 0.12
Nodes (9): ScriptAPI, ScriptConfigLocator, ScriptError, evaluationError, unsupportedPlatform, Foundation, JavaScriptCore, LocalizedError (+1 more)
...
Cohesion: 0.16
Nodes (16): AppKit, KouenCopyMode, KouenCore, KouenTerminalEngine, KouenTerminalKit, KouenTerminalRenderer, KouenTheme, Metal (+8 more)
...
Cohesion: 0.09
Nodes (18): RealPty, .init(id:cwd:shell:rows:cols:scrollbackBytes:extraEnvironment:termProgram:termProgramVersion:scrollbackURL:), ScrollbackEntry, ScrollbackReplaySegment, ShellLaunchProfile, Bool, CChar, DaemonSurfaceID (+10 more)
...
Cohesion: 0.16
Nodes (8): .webView(_:didCommit:), .webView(_:didStartProvisionalNavigation:), MockWebView, Bool, URL, WKNavigation, WKWebView, WKWebViewConfiguration
...
Cohesion: 0.22
Nodes (9): SSHTunnelError, exitedEarly, invalidConfiguration, launchFailed, notReady, Bool, Int32, String (+1 more)

### Community 406 - "main.swift"
Cohesion: 0.10
Nodes (18): Bool, NSCoder, NSEvent, NSPopover, NSRange, NSRect, NSString, NSTextView (+10 more)
...
Cohesion: 0.11
Nodes (8): KeybindingsService, Bool, Command, String, .init(from:), Decoder, CommandParserTests, KeyTableTests
...
Cohesion: 0.31
Nodes (7): CGFloat, NSCoder, SessionID, Void, TaskDashboardView, .init(coder:), .init(onJumpToSession:)
...
Cohesion: 0.07
Nodes (31): clamp(), DotView, .init(coder:), .init(frame:), statusColor(), statusHelp(), Bool, CGFloat (+23 more)
...
Cohesion: 0.22
Nodes (9): ClaudeRunSummary, Date, Double, Int32, String, UUID, KouenCLI, String (+1 more)
...
Cohesion: 0.11
Nodes (13): center, ComposerPanel, .textView(_:doCommandBy:), .textView(_:shouldChangeTextIn:replacementString:), Bool, NSEvent, NSRange, NSTextView (+5 more)
...
Cohesion: 0.06
Nodes (35): MainActor, Void, Typography, SessionDividerRowView, .init(coder:), .init(frame:), SessionGroupHeaderRowView, .init(coder:) (+27 more)
...
Cohesion: 0.15
Nodes (12): Bool, CGFloat, NSCoder, NSEvent, NSTrackingArea, WorkspaceID, WorkspaceSwitcherPanelView, .init(coder:) (+4 more)
...
Cohesion: 0.05
Nodes (26): NSCursor, .interval(_:_:), T, KouenTerminalSurfaceView, .receive(_:), PendingMainHop, SurfaceEmulatorState, SurfaceFrameBuildResult (+18 more)
...
Cohesion: 0.17
Nodes (5): BrowserPaneView, DesignModeElementInfo, NSPopover, String, BrowserPaneViewTests
...
Cohesion: 0.07
Nodes (23): DaemonCommandExecutor, Command, BellScanState, esc, normal, string, stringEsc, PanePipe (+15 more)
...
Cohesion: 0.17
Nodes (5): SelectAllOnClickTextField, NSEvent, NSStackView, Selector, NSAppearance
...
Cohesion: 0.23
Nodes (7): BrowserPaneRegistry, .init(url:paneID:), PaneID, WeakBrowserPaneView, WeakScriptMessageHandler, WebKit, WKScriptMessageHandler
...
### Community 1402 - ".unlinkWindow"
Cohesion: 0.12
Nodes (6): SessionID, GroupedSessionTests, SessionGroup, Set, SurfaceID, Phase67Tests

### Community 1544 - "TargetSpec.swift"
Cohesion: 0.15
Nodes (12): CodingKey, CodingKeys, createdAt, dataBase64, rows, timeMs, type, version (+4 more)
...
Cohesion: 0.12
Nodes (22): KeySpec, Binding, .init(from:), .init(spec:command:note:repeatable:), CodingKeys, bindings, disabledSpecs, id (+14 more)

## Knowledge Gaps
- **3584 isolated node(s):** `AppIntents`, `noActivePane`, `horizontal`, `vertical`, `unsupportedPlatform` (+3579 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **2187 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `Error` to `Changelog Archive`, `CodingKey`, `graphify reference: extra exports and benchmark`, `callingPaneTarget`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `GitPanelView.swift`, `VTParser`, `HarnessTerminalSurfaceView`, `MetalRendererTests`, `HarnessUILibrary`, `SpecialKey`, `HarnessChrome`, `HarnessTerminalSurfaceView`, `CopyModeAction`, `SplitPaneCoordinator`, `.request`, `WorktreeManager`, `SessionGroupHeaderRowView`, `RGBColor`, `.parse`, `Notification`, `.addTab`, `Equatable`, `LegacySnapshot`, `MenuTarget`, `code:bash (harness chat "Use the project map first, then inspect this r)`, `String`, `Task Ledger Archive (Tasks 1–50)`, `TerminalColorGamut`, `HarnessSettings`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `RenderSchedulerTests`, `harness.resource`, `.buildCommand`, `.normalizedKey`, `DaemonServer`, `.keyEvent`, `.handleWake`, `HarnessSplitView`, `TabCell`, `newWindow`, `BellScanState`, `CommandHistorySearchController`, `PasteBufferStore`, `FrecencyDirectoryStore`, `ComposedCell`, `HarnessCLI+Server.swift`, `PrefixKeymap`, `String`, `.compose`, `worktree_isolation_cli.robot`, `XCTestCase`, `.parse`, `TerminalProtocolCompatibilityTests`, `Endpoint`, `HarnessDesign`, `selectWorkspace`, `LSPClient`, `TerminalGridCell`, `HarnessPaths`, `HarnessTerminalSurfaceView`, `TerminalModes`, `P2 — Async IPC Refactor: Design Document`, `AttachInputBatcher`, `shim.c`, `.testRenderEncodeIncrementalDamage160x48`, `PaneContainerView`, `.apply`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `Changelog`, `AnyCodable`, `NSView`, `DamageTrackingTests`, `SoftIconButton`, `[1.3.0-vit] - 2026-06-06`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `.encode`, `.resolve`, `graphify reference: query, path, explain`, `WorkspaceFileTreeView`, `ViEngine`, `HistoryRingBuffer`, `.path`, `ClientSummary`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `GlyphAtlas`, `.install`, `AgentHookInstaller`, `CommandTarget`, `.startWatching`, `ActivePaneService`, `User Story Mapping (MANDATORY)`, `PtyDrainCeilingBenchmark`, `How to use Harness from the terminal only (no GUI)`, `PaneStyleSet`, `AsciiFastPathTests`, `MCPServer`, `.feedBuffer`, `[3.1.2] - 2026-06-16`, `What You Must Do When Invoked`, `LiveResizeTests`, `Int`, `ThaiCombiningMarkTests`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `.jumpToBlock`, `FilePreviewCoordinator`, `ThaiClusterCopyTests.swift`, `URLDetection`, `.decodeKeySpec`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `BlockSummary`, `BoardCard`, `.rects`, `InlineAICompletionView`, `Phase6KeysTests`, `.testOptionLinesAreNotCommands`, `[3.13.1] - 2026-07-02`, `P25 — iOS/iPadOS Support`, `LSPServerRegistry`, `VTConformanceCorpusTests`, `SessionSnapshot`, `GridCompositorTests`, `AppDelegate`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `ScriptRuntime`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `ResizeHUDView`, `[3.4.0] - 2026-06-19`, `AgentSessionSummary`, `.classify`, `MCP Server (harness-mcp)`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `scheduleRender`, `.testDataFrameEncodeVsJSONBase64Output`, `SettingsRemoteView`, `PaneTarget`, `NotchLayoutMetrics`, `CellColorResolverTests`, `GridCompositor`, `TerminalServicesProvider`, `AgentNotchRowSummary`, `ANSIPalette`, `CellColorResolver`, `HarnessPathDisplay`, `ExternalOpenKind`, `WorkbenchCommand`, `TerminalMetalRenderer`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `.make`, `ThemeDocumentTests`, `ReflowPreviewTests`, `NSViewRepresentable`, `BoardViewController`, `workspace`, `release-hotfix.sh`, `GitMetadataProvider`, `WindowTitleStripView`, `ThemeFileServiceTests`, `Sidebar SwiftUI Migration — Knowledge`, `listSurfaces`, `.install`, `HarnessSidebarPanelViewController`, `.welcome`, `.userNotificationCenter`, `.path`, `[2.2.4] - 2026-06-11`, `[3.11.2] - 2026-06-28`, `DefaultTerminalManager`, `StatusLineView.swift`, `WindowSession`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `.run`, `renumberWindows`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `.rememberTabForReopen`, `FormatColor`, `click_ui_element`, `code:bash (harness-cli install-hooks hermes)`, `AgentHookStrategy`, `StatusLineWidthTests`, `Process`, `JSONDecoder`, `Fixes Applied (layered)`, `NotificationBus`, `settings.json`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `00-inception-plan.md`, `.script`, `.scrollWheel`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `UInt64`, `DesktopNotifier`, `LayoutNode`, `WorkspaceSymbolIndex`, `worktree_isolation.robot`, `.theme`, `.drawGlyph`, `.recordReapedGenerationForTesting`, `.makeModel`, `CommandExecutionError`, `Foundation`, `code:bash (harness-cli install-hooks openclaw)`, `Background Polling & Snapshot Fanout — P22`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `GPU Animation Pattern — Layout Once, GPU Paints`, `.handleCat`, `FormatStyledSegment.swift`, `projectGroupRootPath`, `[2.2.4] - 2026-06-11`, `generate-cheatsheet.js`, `Consumers`, `DaemonStats`, `Fixes Applied (v3.9.1+)`, `DynamicInstanceBuffer`, `.tabIndex(tabID:)`, `.unlinkWindow`, `SurfaceProgressTrackerTests.swift`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `HarnessCLITests`, `AppKit + Metal Patterns`, `.load`, `PresentAttempt`, `AgentIconRenderer`, `main.swift`, `IPC Architecture`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `Task 1: Redesign Session Sidebar`, `HintModeOverlay`, `.parseDiffHunks`, `.delay`, `PathToken`, `Project History`, `.init`, `SessionEditor`, `main.swift`, `Section`, `.update`, `ComposerPanel`, `AsyncCLIResultBox`, `HarnessOnboarding`, `String`, `Added`, `ScrollbackTests`, `Command Prompt Architecture`, `.resolve`, `Changed`, `[3.10.1] - 2026-06-27`, `printThemePreview`, `requireSessionID`, `resolvedCLIPath`, `.json`, `graphify reference: extra exports and benchmark`, `.panePathLookup`?**
  _High betweenness centrality (0.265) - this node is a cross-community bridge._
- **Why does `KouenCore` connect `Foundation` to `Changelog Archive`, `CodingKey`, `.handleNormal`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `Command`, `PerformanceBenchmarks`, `KittyKeyboardTests`, `MetalRendererTests`, `HarnessUILibrary`, `SpecialKey`, `.text`, `.request`, `WorktreeManager`, `SessionGroupHeaderRowView`, `Harness tmux-style capabilities`, `install-app.sh`, `Sendable`, `Task Ledger Archive (Tasks 1–50)`, `LegacySnapshot`, `NSObject`, `MenuTarget`, `String`, `[3.12.0] - 2026-06-30`, `CodingKeys`, `HarnessSettings`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `.normalizedKey`, `HookEvent`, `DaemonServer`, `ScrollbackPersistenceTests`, `.keyEvent`, `.handleWake`, `NSPanel`, `BellScanState`, `CommandHistorySearchController`, `ViEngine`, `ComposedCell`, `HarnessCLI+Server.swift`, `.text`, `TerminalProgressReport`, `DecoKind`, `FileTreeKeyboardNavigator`, `worktree_isolation_cli.robot`, `XCTestCase`, `.statusLineSet`, `.parse`, `Endpoint`, `HarnessDesign`, `KouenCLITests.swift`, `LSPClient`, `LSPDiagnostic`, `.tomlKouenBlock`, `SessionCoordinator`, `code:bash (# Terminal 1: Create workspace with long-running job)`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `4. Technical Architecture`, `.dispatch`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `MainSplitViewController`, `Changelog`, `domain-design.md`, `AgentNotchViewModel`, `.resolve`, `ViEngine`, `SoftIconButton`, `BrowserResponsePayload`, `.makeSnapshot`, `DamageTrackingTests`, `.firstWaitingTab`, `.encode`, `clearSelection`, `PaneNode`, `WorkspaceFileTreeView`, `SessionGroup`, `Pipe`, `String`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `.install`, `AgentHookInstaller`, `.load`, `code:js (// ~/.config/harness/init.js)`, `stability_release.robot`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `User Story Mapping (MANDATORY)`, `CopyModeGridSource`, `DecodedImage`, `PaletteMode`, `MCPServer`, `EnvironmentStore`, `New Tab`, `FileTreeWatcher`, `What You Must Do When Invoked`, `ThaiCombiningMarkTests`, `[3.8.0] - 2026-06-22`, `Harness Terminal — IDE Sidebar Feature Branch`, `MatchCategory`, `AmbientBackground`, `sessionCreated`, `.recordReapedGenerationForTesting`, `ActiveTabCloseDisposition`, `ThaiClusterCopyTests.swift`, `AgentTableEntry`, `ReflowCorpusTests`, `.decodeKeySpec`, `RGBColorTests`, `InlineAICompletionView`, `GridCompositorTests`, `TerminalScreen`, `P25 — iOS/iPadOS Support`, `AppDelegate`, `ScriptRuntime`, `[2.3.0] - 2026-06-11`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `[2.5.1] - 2026-06-12`, `[3.4.0] - 2026-06-19`, `BinaryInstaller`, `MainWindowController`, `.classify`, `BinaryInstallerVersionTests`, `MCP Server (harness-mcp)`, `PaletteModel`, `FileTabManager`, `AutomationScheduler`, `CopyModeState`, `PaneDropZoneOverlay`, `.translate`, `NotchLayoutMetrics`, `.lines`, `CellColorResolverTests`, `Prompt`, `Section`, `ANSIPalette`, `HarnessPathDisplay`, `SSHTunnelManagerTests`, `sessionRow`, `graphify reference: incremental update and cluster-only`, `TerminalGridCellLayoutTests`, `TextGrid`, `.scan`, `WorkbenchCommand`, `p11_scripting.robot`, `.make`, `AgentBridge`, `.make`, `FileNode`, `ThemeDocumentTests`, `.renderFixture`, `DaemonMetrics`, `ReflowPreviewTests`, `HarnessTerminalSurfaceWorkerTests`, `[3.4.0] - 2026-06-19`, `NSViewRepresentable`, `Split Right`, `BoardViewController`, `GitMetadataProvider`, `Sidebar SwiftUI Migration — Knowledge`, `ThemeFileServiceTests`, `.welcome`, `Browser Pane (P14)`, `.install`, `KeySpec`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `reorderSession`, `CLICommand`, `DisplayPanesOverlay`, `TerminalScrollbarView`, `code:bash (harness-cli install-hooks hermes)`, `.apply`, `.load`, `GitHubCLIClient`, `jobs`, `ThemeDiagnostics`, `.encodeMouse`, `00-inception-plan.md`, `ViPathTokenTests`, `Send Ex Command`, `.selectedText`, `Terminal AI Chat (⌘I inline overlay)`, `FormatColor`, `UInt64`, `.theme`, `.snapshot`, `CommandExecutionError`, `CSIParams`, `code:bash (harness-cli install-hooks openclaw)`, `code:bash (harness-cli install-hooks pi)`, `[2.2.3] - 2026-06-09`, `DaemonLifecycleTests`, `Background Polling & Snapshot Fanout — P22`, `Architecture Decisions — harness-terminal`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `GPU Animation Pattern — Layout Once, GPU Paints`, `MCPServer`, `.handleCat`, `State`, `FormatStyledSegment.swift`, `RGBColor`, `generate-cheatsheet.js`, `Consumers`, `SurfaceRegistryTests.swift`, `Tab`, `.encode`, `P13 — Embedded Browser Pane (cmux parity)`, `.install`, `.unlinkWindow`, `ThaiClusterRenderTests`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `UI Automation — Robot Framework (P18)`, `Split Panes (NSSplitView)`, `IPC Architecture`, `go.json`, `yaml.json`, `HintModeOverlay`, `.delay`, `.updateTabTitle`, `LaunchdServiceInstaller`, `WaitForRegistry`, `ThaiClusterCopyTests.swift`, `Feature Specs`, `GroupedSessionDaemonTests`, `BlockContextMenuTests`, `Section`, `.normalizedKey`, `.run`, `.json`, `.handleWake`, `ReflowFastPathTests`, `Darwin`, `HarnessOnboarding`, `.steps`, `Added`, `Changed`, `.json`, `ACP Client (Shelved)`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `Foundation` connect `ThemeFileServiceTests` to `Changelog Archive`, `CodingKey`, `graphify reference: extra exports and benchmark`, `.handleNormal`, `IPCRequest`, `Command`, `VTParser`, `HarnessChrome`, `SpecialKey`, `ANSIPalette`, `SplitPaneCoordinator`, `CopyModeAction`, `.request`, `RGBColor`, `Sendable`, `Task Ledger Archive (Tasks 1–50)`, `DaemonClient`, `MenuTarget`, `String`, `.startWatching`, `[3.12.0] - 2026-06-30`, `HarnessSettings`, `HarnessSidebarPanelViewController.swift`, `CodingKeys`, `harness.resource`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `HookEvent`, `markPane`, `.keyEvent`, `.handleWake`, `BellScanState`, `PasteBufferStore`, `FrecencyDirectoryStore`, `HarnessCLI+Server.swift`, `.text`, `ShellIntegration`, `FileTreeKeyboardNavigator`, `.statusLineSet`, `OptionStore`, `.parse`, `Endpoint`, `KouenCLITests.swift`, `DaemonSubscription`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `SessionCoordinator`, `code:bash (# Terminal 1: Create workspace with long-running job)`, `AttachInputBatcher`, `PaneContainerView`, `4. Technical Architecture`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `DaemonLauncher`, `AnyCodable`, `Recipe`, `Changelog`, `ScriptFileWatcher`, `AgentNotchViewModel`, `.resolve`, `DamageTrackingTests`, `BrowserResponsePayload`, `.firstWaitingTab`, `ActiveTabCloseDisposition`, `SessionGroup`, `PaneNode`, `WorkspaceFileTreeView`, `ViEngine`, `Pipe`, `HistoryRingBuffer`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `object`, `AgentHookInstaller`, `[3.10.1] - 2026-06-27`, `CommandTarget`, `.startWatching`, `ActivePaneService`, `User Story Mapping (MANDATORY)`, `PtyDrainCeilingBenchmark`, `graphify reference: query, path, explain`, `TerminalHostView`, `CopyModeGridSource`, `PaneStyleSet`, `AsciiFastPathTests`, `DecodedImage`, `FileTreeWatcher`, `EnvironmentStore`, `[3.1.2] - 2026-06-16`, `.evaluate`, `BrowserIntegrationController`, `Int`, `LiveResizeTests`, `[3.9.1] - 2026-06-22`, `MatchCategory`, `AmbientBackground`, `ColorKind`, `AgentKind`, `CommandPromptController`, `ActiveTabCloseDisposition`, `FilePreviewCoordinator`, `URLDetection`, `.decodeKeySpec`, `BlockSummary`, `.hold`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `GridCompositorTests`, `Error`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `[3.4.0] - 2026-06-19`, `BinaryInstallerVersionTests`, `MCP Server (harness-mcp)`, `PaletteModel`, `TerminalProgressReport`, `ReplayStep`, `grok`, `HarnessCLI`, `scheduleRender`, `PaneDropZoneOverlay`, `PaneTarget`, `.translate`, `NotchLayoutMetrics`, `.lines`, `CellColorResolverTests`, `Prompt`, `Section`, `ReplayStep`, `AgentNotchRowSummary`, `TerminalServicesProvider`, `CellColorResolver`, `HarnessPathDisplay`, `FileChangeWatcher`, `SSHTunnelManagerTests`, `sessionRow`, `.decide`, `HarnessGridTerminalTests`, `ExternalOpenKind`, `TerminalGridCellLayoutTests`, `graphify reference: incremental update and cluster-only`, `.scan`, `.make`, `.copySelection`, `PaneBorderStatus`, `TerminalMetalRenderer`, `.make`, `FileNode`, `ThemeDocumentTests`, `.renderFixture`, `ReflowPreviewTests`, `NSViewRepresentable`, `BoardViewController`, `BundledThemesData.swift`, `release-hotfix.sh`, `Sidebar SwiftUI Migration — Knowledge`, `WindowTitleStripView`, `.welcome`, `Browser Pane (P14)`, `.install`, `SGRMouseEvent`, `[2.5.0] - 2026-06-12`, `.run`, `reorderSession`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `FormatColor`, `click_ui_element`, `JSONDecoder`, `Fixes Applied (layered)`, `.load`, `AgentApprovalBar`, `NotificationBus`, `settings.json`, `jobs`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `ThemeDiagnostics`, `ViPathTokenTests`, `Send Ex Command`, `.selectedText`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `.unmarkText`, `code:bash (# In a Harness pane:)`, `FormatColor`, `DesktopNotifier`, `FloatingPaneController`, `.theme`, `.reopenClosedTab`, `.recordReapedGenerationForTesting`, `Foundation`, `code:bash (harness-cli install-hooks openclaw)`, `[2.2.3] - 2026-06-09`, `Architecture Decisions — harness-terminal`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `MCPServer`, `P10: Performance and Feature Roadmap (Terminal First, IDE Convenient)`, `SurfaceProgressTracker`, `.handleCat`, `[3.5.1] - 2026-06-20`, `State`, `FormatStyledSegment.swift`, `SessionEditor.swift`, `generate-cheatsheet.js`, `[2.2.4] - 2026-06-11`, `Tab`, `.encode`, `MCPServer`, `ThaiClusterRenderTests`, `terminal_stress_runner.py`, `Darwin`, `UI Automation — Robot Framework (P18)`, `.load`, `AgentIconRenderer`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `javascript.json`, `json.json`, `HintModeOverlay`, `Bug — Cmd+\ sidebar toggle gone after collapse`, `.delay`, `Competitive Position (as of v3.12.0, 2026-07-02)`, `PathToken`, `LaunchdServiceInstaller`, `.init`, `RawRepresentable`, `BlockContextMenuTests`, `main.swift`, `Modifiers`, `.normalizedKey`, `ClaudeRunSummary`, `.run`, `TerminalEmulator.swift`, `.encode`, `.handleWake`, `ReflowFastPathTests`, `Darwin`, `HarnessOnboarding`, `Added`, `Service Decomposition — SessionCoordinator (P17)`, `.json`, `ACP Client (Shelved)`, `KittyGraphicsCommand`, `.panePathLookup`?**
