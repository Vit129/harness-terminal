# Graph Report - kouen-terminal  (2026-08-16)

## Corpus Check
- 781 files · ~817,312 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14766 nodes · 35029 edges · 3014 communities (893 shown, 2121 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 3996 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8e04f102`
...
1. `IPCRequest` - bridges 171 areas (191 edges)
2. `Command` - bridges 101 areas (107 edges)
3. `IPCResponse` - bridges 72 areas (94 edges)
4. `SessionCoordinator` - bridges 57 areas (131 edges)
5. `KouenPaths` - bridges 57 areas (122 edges)
6. `MenuTarget` - bridges 56 areas (68 edges)
7. `SurfaceRegistry` - bridges 55 areas (197 edges)
...
## Communities (3014 total, 2121 thin omitted)
...
Cohesion: 0.09
Nodes (15): tab, SessionEditor, .addSurface(tabID:paneID:), .tab(containingPaneID:), .tab(for:), .tab(forSurfaceKey:), .tabIndex(surfaceID:), .tabIndex(surfaceKey:) (+7 more)
...
Cohesion: 0.14
Nodes (14): IndexingIterator, LayoutTemplate, surfaceID, .addSurface(to:paneID:surfaceID:cwd:), .split(node:targetPaneID:direction:paneCount:before:), .split(node:targetPaneID:with:direction:beforeTarget:), .surfaceID(forPaneID:in:), Bool (+6 more)
...
Cohesion: 0.07
Nodes (35): Decodable, AssistantLine, ClaudeCodeHarness, Content, Message, Profile, edit, readonly (+27 more)
...
Cohesion: 0.13
Nodes (11): ChromeBackdrop, .init(role:), KouenDesign, RuntimeGlassEffectView, Bool, NSColor, NSPoint, NSSize (+3 more)
...
Cohesion: 0.08
Nodes (12): HistoryLine, ImagePlacement, Pen, SavedCursor, Bool, ClosedRange, Range, TerminalCellWidth (+4 more)
...
Cohesion: 0.15
Nodes (12): LSPClient, LSPClientError, missingPipe, processNotRunning, requestFailed, serverNotExecutable, FileHandle, Int32 (+4 more)
...
Cohesion: 0.07
Nodes (30): Darwin, Glibc, DaemonClientError, connectionFailed, timeout, unexpectedResponse, writeFailed, EndpointError (+22 more)
...
Cohesion: 0.13
Nodes (28): MTLClearColor, MTLCommandBuffer, BgInstance, CursorCacheKey, DecoInstance, EncodedFrameInstances, EncodedRowInstances, GlyphInstance (+20 more)
...
### Community 64 - ".text"
Cohesion: 0.21
Nodes (8): DaemonClient, KouenCLI, String, KouenCLI, String, UUID, T, Void
...
Cohesion: 0.09
Nodes (20): DaemonCommandExecutor, SurfaceRegistry, SessionSnapshot, Set, PendingVersionBanner, welcome, whatsNew, State (+12 more)

### Community 98 - "4. Technical Architecture"
Cohesion: 0.20
Nodes (8): PaneLifecycleManager, NSView, PaneID, PaneNode, Set, String, Tab, NSUserInterfaceItemIdentifier

### Community 99 - ".dispatch"
Cohesion: 0.11
Nodes (27): TerminalColorGamut, auto, displayP3, sRGB, TerminalColorRenderingMode, accurate, vivid, .init(themeName:fontFamily:fontSize:vivid:colorRendering:colorGamut:offMainParserFramePipeline:liveResizeReflow:) (+19 more)
...
Cohesion: 0.21
Nodes (5): AgentDetection, AgentTable, Int32, ProcessScan, Int32
...
Cohesion: 0.09
Nodes (13): AnyCancellable, AgentNotchViewModel, Bool, CGFloat, String, Task, NotchPanel, Bool (+5 more)
...
Cohesion: 0.24
Nodes (4): RecipePickerModel, NSWindow, RecipePickerModelMergeTests, Bool

### Community 132 - "AgentHookInstaller"
Cohesion: 0.07
Nodes (25): CommandIPCTranslator, CommandTarget, CommandTranslation, clientLocal, requests, unresolved, Command, PaneID (+17 more)
...
Cohesion: 0.19
Nodes (19): Codable, BrowserCookie, BrowserElement, BrowserElementBounds, BrowserNetworkEntry, BrowserSnapshot, BufferSummary, HookEntry (+11 more)
...
Cohesion: 0.11
Nodes (18): KeyRecorderRepresentable, String, Void, OverlayBackground, Context, OverlayBackground, Context, .init(coder:) (+10 more)
...
Cohesion: 0.06
Nodes (33): Bool, String, UUID, TaskDaemonBridge, CGFloat, NSCoder, SessionID, String (+25 more)
...
Cohesion: 0.09
Nodes (21): Date, String, TerminalBlock, TerminalBlockStore, .block(atPromptLine:), .block(id:), .block(atPromptLine:), .block(id:) (+13 more)
...
Cohesion: 0.26
Nodes (6): Process, .init(makeTunnelProcess:reachabilityProbe:), Bool, RemoteHost, URL, Tunnel
...
Cohesion: 0.08
Nodes (33): .init(entry:), AgentChipView, BoardColumnKind, ChromeRole, sidebar, tabBar, Divider, FontSize (+25 more)
...
Cohesion: 0.14
Nodes (14): Motion, CAMediaTimingFunction, NSWindowController, KouenOnboarding, Bool, ImmersiveOnboardingWindowController, .init(coder:), .init(onDismiss:) (+6 more)
...
Cohesion: 0.11
Nodes (14): .init(frame:), Kind, primary, secondary, KouenPillButton, .init(title:kind:), SoftIconButton, .init(frame:) (+6 more)

### Community 197 - "AgentSessionSummary"
Cohesion: 0.12
Nodes (10): FlippedView, .removeWorktreeAction(_:), NSButton, NSColor, NSScrollView, NSStackView, NSTextField, NSClickGestureRecognizer (+2 more)
...
Cohesion: 0.07
Nodes (38): DecodedImage, UInt8, BlockSelection, CursorRender, CursorStyle, bar, block, underline (+30 more)
...
Cohesion: 0.18
Nodes (4): AgentDetector, Date, TimeInterval, AgentSnapshot
...
Cohesion: 0.06
Nodes (17): keys, CGImage, ImageLimits, Bool, ImageDecoder, Data, ITerm2InlineImage, Bool (+9 more)
...
Cohesion: 0.15
Nodes (12): Logger, OSSignposter, LatencyMonitor, UInt64, FrameDropCause, encodeFailure, nilDrawable, FrameSignposter (+4 more)
...
Cohesion: 0.18
Nodes (6): DaemonSessionService, .request(_:timeout:), Bool, SessionSnapshot, TimeInterval, Endpoint

### Community 245 - "ThemeDocumentTests"
Cohesion: 0.19
Nodes (10): InputGate, SurfaceIO, Data, KouenTerminalSurfaceView, String, SurfaceID, UInt16, UInt64 (+2 more)
...
Cohesion: 0.24
Nodes (6): PickerItem, historyBlock, recipe, SurfaceID, String, SurfaceID
...
Cohesion: 0.16
Nodes (15): CustomStringConvertible, os, DaemonSessionError, daemonError, unexpectedResponse, String, attribute_lines(), main() (+7 more)
...
Cohesion: 0.11
Nodes (14): BrowserIntegrationController, NSView, PaneID, HitTestPassthroughView, PaneContainerView, .init(node:cwd:themeName:existingHosts:existingBrowserPanes:), .init(paneID:), NSPoint (+6 more)
...
Cohesion: 0.12
Nodes (15): string, AgentNotification, OSCNotificationParser, DaemonSurfaceID, Data, Date, String, SurfaceID (+7 more)
...
Cohesion: 0.15
Nodes (14): DiffLineType, added, deleted, modified, Notification.Name, Bool, NSCoder, NSRect (+6 more)
...
Cohesion: 0.08
Nodes (23): Error, ExpressibleByStringLiteral, InstallError, unsupported, DaemonError, alreadyRunning, bindFailed, listenFailed (+15 more)
...
Cohesion: 0.22
Nodes (5): CoreGraphics, CoreText, ImageIO, NerdFontFallbackTests, Bool
...
Cohesion: 0.26
Nodes (5): KouenCLI, SessionID, String, SessionGroup, SessionSnapshot
...
Cohesion: 0.26
Nodes (8): AppKit, KouenCopyMode, KouenTerminalEngine, KouenTerminalRenderer, KouenTheme, Metal, QuartzCore, XCTest
...
### Community 402 - "View"
Cohesion: 0.13
Nodes (24): Color, ButtonStyle, CommandRow, GlassCard, GlassPrimaryButtonStyle, GlassSecondaryButtonStyle, GlassSmallButtonStyle, GlassStatusButtonStyle (+16 more)
...
Cohesion: 0.14
Nodes (10): NSEvent, NSPopover, NSRange, NSString, Void, SyntaxTextView, .init(frame:), .lspPosition(characterOffset:) (+2 more)
...
Cohesion: 0.16
Nodes (13): atomicWrite(), backupCorruptFile(), fnv1aHex(), KouenPaths, KouenPathsError, socketPathTooLong, Bool, Data (+5 more)
...
### Community 427 - ".delay"
Cohesion: 0.12
Nodes (10): .agentInfo(forWorktreePath:tabs:), Tab, AgentNotchPresentation, closed, open, peek, AgentNotchWindowActivator, Combine (+2 more)
...
Cohesion: 0.13
Nodes (15): Int, TerminalGridSnapshot, .readGrid(scrollbackOffset:), ImagePlacementSnapshot, SemanticMark, TerminalCursor, TerminalCursorShape, bar (+7 more)
...
Cohesion: 0.14
Nodes (11): clamp(), statusHelp(), Configuration, Date, String, T, TabBarIconButtonStyle, TabBarInlineIconButtonStyle (+3 more)
...
Cohesion: 0.18
Nodes (12): .init(url:paneID:), .init(url:paneID:webView:), .webView(_:createWebViewWith:for:windowFeatures:), .webView(_:didFinish:), BrowserTab, UUID, WKWebView, WeakScriptMessageHandler (+4 more)
...
Cohesion: 0.14
Nodes (13): Identifiable, AgentRoutingRuleSummary, Bool, String, UUID, AutomationSummary, Bool, Date (+5 more)
...
Cohesion: 0.06
Nodes (36): CommandHistorySearchController, .tableView(_:heightOfRow:), .tableView(_:rowViewForRow:), .tableView(_:shouldSelectRow:), .tableView(_:viewFor:row:), HistoryItemView, .init(coder:), .init(command:query:) (+28 more)
...
Cohesion: 0.05
Nodes (27): NSCursor, .interval(_:_:), T, KouenTerminalSurfaceView, .receive(_:), PendingMainHop, PresentAttempt, encodeFailure (+19 more)
...
Cohesion: 0.19
Nodes (6): BrowserPaneView, .init(title:isActive:onSelect:onClose:), DesignModeElementInfo, Bool, NSPopover, String
...
Cohesion: 0.12
Nodes (10): Command, PanePipe, Bool, FileHandle, Int32, SessionID, String, TabID (+2 more)
...
Cohesion: 0.08
Nodes (10): KouenDaemonCore, ClaudeCodeHarnessIPCTests, String, URL, GroupedSessionDaemonTests, String, URL, MobileBridgeSpawnTests (+2 more)
...
Cohesion: 0.09
Nodes (14): Bool, SessionCoordinator, String, ThemeService, InlineAICompletionController, KouenSettings, String, KouenOptions (+6 more)
...
Cohesion: 0.21
Nodes (5): Bool, String, BlockSummary, Date, String
...
## Knowledge Gaps
- **3058 isolated node(s):** `AppIntents`, `noActivePane`, `horizontal`, `vertical`, `unsupportedPlatform` (+3053 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **2121 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `.hitTest` to `Changelog Archive`, `CodingKey`, `graphify reference: extra exports and benchmark`, `callingPaneTarget`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `.testManyConcurrentSubscribersAllReceiveOutput`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `GitPanelView.swift`, `KittyKeyboardTests`, `VTParser`, `.applyPreedit`, `MetalRendererTests`, `HarnessUILibrary`, `SpecialKey`, `HarnessChrome`, `HarnessTerminalSurfaceView`, `CopyModeAction`, `SplitPaneCoordinator`, `.request`, `WorktreeManager`, `Harness tmux-style capabilities`, `SessionGroupHeaderRowView`, `.parse`, `RGBColor`, `Notification`, `.addTab`, `Equatable`, `LegacySnapshot`, `MenuTarget`, `code:bash (harness chat "Use the project map first, then inspect this r)`, `String`, `Task Ledger Archive (Tasks 1–50)`, `HarnessSettings`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `RenderSchedulerTests`, `harness.resource`, `.buildCommand`, `.normalizedKey`, `DaemonServer`, `.keyEvent`, `.handleWake`, `HarnessSplitView`, `TabCell`, `newWindow`, `BellScanState`, `CommandHistorySearchController`, `3.2 สิ่งที่ implement แล้ว`, `PasteBufferStore`, `FrecencyDirectoryStore`, `ComposedCell`, `HarnessCLI+Server.swift`, `PrefixKeymap`, `TerminalProgressReport`, `String`, `worktree_isolation_cli.robot`, `XCTestCase`, `.statusLineSet`, `.parse`, `Endpoint`, `TerminalProtocolCompatibilityTests`, `HarnessDesign`, `selectWorkspace`, `LSPClient`, `TerminalGridCell`, `HarnessPaths`, `.tomlKouenBlock`, `HarnessTerminalSurfaceView`, `TerminalModes`, `P2 — Async IPC Refactor: Design Document`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `.dispatch`, `Session Grouping and Split Session Plan`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `Changelog`, `domain-design.md`, `AgentNotchViewModel`, `AnyCodable`, `DamageTrackingTests`, `SoftIconButton`, `[1.3.0-vit] - 2026-06-06`, `.makeSnapshot`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `.resolve`, `graphify reference: query, path, explain`, `WorkspaceFileTreeView`, `ViEngine`, `String`, `HistoryRingBuffer`, `.path`, `ClientSummary`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `GlyphAtlas`, `.install`, `AgentHookInstaller`, `CommandTarget`, `.startWatching`, `ActivePaneService`, `User Story Mapping (MANDATORY)`, `PtyDrainCeilingBenchmark`, `CopyModeGridSource`, `How to use Harness from the terminal only (no GUI)`, `PaneStyleSet`, `AsciiFastPathTests`, `MCPServer`, `TriState`, `.feedBuffer`, `.evaluate`, `LiveResizeTests`, `Int`, `ThaiCombiningMarkTests`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `.jumpToBlock`, `FilePreviewCoordinator`, `URLDetection`, `.decodeKeySpec`, `[1.5.1] - 2026-06-06`, `BinaryRefresherTests`, `BlockSummary`, `Added`, `BoardCard`, `InlineAICompletionView`, `Phase6KeysTests`, `.testOptionLinesAreNotCommands`, `[3.13.1] - 2026-07-02`, `P25 — iOS/iPadOS Support`, `VTConformanceCorpusTests`, `LSPServerRegistry`, `SessionSnapshot`, `GridCompositorTests`, `AppDelegate`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `user-stories.md`, `ScriptRuntime`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `ResizeHUDView`, `[3.4.0] - 2026-06-19`, `AgentSessionSummary`, `.classify`, `.start`, `MCP Server (harness-mcp)`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `.testDataFrameEncodeVsJSONBase64Output`, `PaneTarget`, `NotchLayoutMetrics`, `CellColorResolverTests`, `GridCompositor`, `TerminalServicesProvider`, `AgentNotchRowSummary`, `CellColorResolver`, `HarnessPathDisplay`, `ExternalOpenKind`, `P10 Task: Lazy Scrollback Reflow`, `WorkbenchCommand`, `TerminalMetalRenderer`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `.make`, `ThemeDocumentTests`, `ReflowPreviewTests`, `workspace`, `release-hotfix.sh`, `Sidebar SwiftUI Migration — Knowledge`, `WindowTitleStripView`, `listSurfaces`, `.welcome`, `.install`, `HarnessSidebarPanelViewController`, `.userNotificationCenter`, `.path`, `[2.2.4] - 2026-06-11`, `[3.11.2] - 2026-06-28`, `DefaultTerminalManager`, `StatusLineView.swift`, `WindowSession`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `.run`, `renumberWindows`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `.rememberTabForReopen`, `FormatColor`, `click_ui_element`, `code:bash (harness-cli install-hooks hermes)`, `AgentHookStrategy`, `StatusLineWidthTests`, `Process`, `JSONDecoder`, `Fixes Applied (layered)`, `settings.json`, `HarnessPaths.swift`, `.parse`, `00-inception-plan.md`, `.scrollWheel`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `Focus Persistence — Per-Session-Tab Pane Focus (RL-043)`, `DesktopNotifier`, `LayoutNode`, `WorkspaceSymbolIndex`, `worktree_isolation.robot`, `.theme`, `.drawGlyph`, `.makeModel`, `CommandExecutionError`, `FileViewerViewController`, `Background Polling & Snapshot Fanout — P22`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `P10: Performance and Feature Roadmap (Terminal First, IDE Convenient)`, `.handleCat`, `FormatStyledSegment.swift`, `generate-cheatsheet.js`, `[2.2.4] - 2026-06-11`, `Fixes Applied (v3.9.1+)`, `Consumers`, `DaemonStats`, `Git Panel`, `P13 — Embedded Browser Pane (cmux parity)`, `DynamicInstanceBuffer`, `ScrollReuseTests`, `.tabIndex(tabID:)`, `Identifiable`, `SurfaceProgressTrackerTests.swift`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `HarnessCLITests`, `AppKit + Metal Patterns`, `.load`, `AgentIconRenderer`, `main.swift`, `IPC Architecture`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `go.json`, `rust.json`, `FilePreviewCoordinatorTabScopeTests`, `HintModeOverlay`, `.parseDiffHunks`, `PathToken`, `Project History`, `.init`, `SessionEditor`, `RemoteHostStore`, `main.swift`, `Modifiers`, `RunState`, `HarnessOnboarding`, `String`, `Added`, `ScrollbackTests`, `Command Prompt Architecture`, `.resolve`, `TabPillView`, `[3.10.1] - 2026-06-27`, `printThemePreview`, `requireSessionID`, `resolvedCLIPath`, `.json`, `.locate`, `graphify reference: extra exports and benchmark`, `.panePathLookup`?**
  _High betweenness centrality (0.311) - this node is a cross-community bridge._
- **Why does `KouenCore` connect `.delay` to `Changelog Archive`, `.handleNormal`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `Command`, `.testManyConcurrentSubscribersAllReceiveOutput`, `KittyKeyboardTests`, `HarnessTerminalSurfaceView`, `.applyPreedit`, `MetalRendererTests`, `HarnessUILibrary`, `SpecialKey`, `.text`, `ANSIPalette`, `SplitPaneCoordinator`, `.request`, `WorktreeManager`, `Harness tmux-style capabilities`, `SessionGroupHeaderRowView`, `.parse`, `install-app.sh`, `Task Ledger Archive (Tasks 1–50)`, `Equatable`, `LegacySnapshot`, `NSObject`, `String`, `[3.12.0] - 2026-06-30`, `CodingKeys`, `HarnessSettings`, `RenderSchedulerTests`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `.normalizedKey`, `HookEvent`, `DaemonServer`, `ScrollbackPersistenceTests`, `.keyEvent`, `.handleWake`, `NSPanel`, `BellScanState`, `CommandHistorySearchController`, `ViEngine`, `HarnessCLI+Server.swift`, `.text`, `TerminalProgressReport`, `Completed Plans Archive`, `FileTreeKeyboardNavigator`, `worktree_isolation_cli.robot`, `XCTestCase`, `.statusLineSet`, `.parse`, `TerminalProtocolCompatibilityTests`, `Endpoint`, `HarnessDesign`, `KouenCLITests.swift`, `LSPClient`, `LSPDiagnostic`, `.tomlKouenBlock`, `SessionCoordinator`, `Zombie View Crashes on macOS 26.5 + Swift 6.3.2`, `code:bash (# Terminal 1: Create workspace with long-running job)`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `4. Technical Architecture`, `.dispatch`, `Session Grouping and Split Session Plan`, `Changelog`, `domain-design.md`, `AgentNotchViewModel`, `ScriptFileWatcher`, `DamageTrackingTests`, `SoftIconButton`, `BrowserResponsePayload`, `.makeSnapshot`, `.resolve`, `.firstWaitingTab`, `.encode`, `clearSelection`, `PaneNode`, `WorkspaceFileTreeView`, `SessionGroup`, `Pipe`, `String`, `.install`, `AgentHookInstaller`, `.load`, `code:js (// ~/.config/harness/init.js)`, `stability_release.robot`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `User Story Mapping (MANDATORY)`, `.testPaneLeafLegacyDecodeBackfillsSurfaceTabs`, `DecodedImage`, `MCPServer`, `FileTreeWatcher`, `EnvironmentStore`, `New Tab`, `What You Must Do When Invoked`, `ThaiCombiningMarkTests`, `[3.8.0] - 2026-06-22`, `Harness Terminal — IDE Sidebar Feature Branch`, `MatchCategory`, `AmbientBackground`, `sessionCreated`, `.recordReapedGenerationForTesting`, `AgentTableEntry`, `ReflowCorpusTests`, `.decodeKeySpec`, `BoardCard`, `RGBColorTests`, `InlineAICompletionView`, `GridCompositorTests`, `TerminalScreen`, `P25 — iOS/iPadOS Support`, `AppDelegate`, `user-stories.md`, `ScriptRuntime`, `[2.3.0] - 2026-06-11`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `[2.5.1] - 2026-06-12`, `BinaryInstaller`, `MainWindowController`, `.classify`, `BinaryInstallerVersionTests`, `MCP Server (harness-mcp)`, `PaletteModel`, `FileTabManager`, `AutomationScheduler`, `CopyModeState`, `PaneDropZoneOverlay`, `.translate`, `CellColorResolverTests`, `GridCompositor`, `ScrollbackFile`, `Prompt`, `Section`, `ANSIPalette`, `HarnessPathDisplay`, `SSHTunnelManagerTests`, `sessionRow`, `graphify reference: incremental update and cluster-only`, `TerminalGridCellLayoutTests`, `TextGrid`, `.scan`, `WorkbenchCommand`, `p11_scripting.robot`, `.make`, `AgentBridge`, `.make`, `.renderFixture`, `DaemonMetrics`, `ReflowPreviewTests`, `[3.4.0] - 2026-06-19`, `SessionCoordinator`, `HarnessTerminalSurfaceWorkerTests`, `Split Right`, `Sidebar SwiftUI Migration — Knowledge`, `.welcome`, `Browser Pane (P14)`, `.install`, `code:bash (# Old (agent-specific):)`, `KeySpec`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `reorderSession`, `CLICommand`, `DisplayPanesOverlay`, `TerminalScrollbarView`, `After all done, come back and update agent-memory/memory.md and agent-memory/plans/p14-web-browser-pane.md.`, `code:bash (harness-cli install-hooks hermes)`, `.apply`, `.load`, `GitHubCLIClient`, `jobs`, `ThemeDiagnostics`, `.encodeMouse`, `00-inception-plan.md`, `ViPathTokenTests`, `Send Ex Command`, `Terminal AI Chat (⌘I inline overlay)`, `Memory — harness-terminal`, `FormatColor`, `.theme`, `ImmersivePalette.swift`, `.recordReapedGenerationForTesting`, `RealPty`, `CommandExecutionError`, `Foundation`, `code:bash (harness-cli install-hooks pi)`, `DaemonLifecycleTests`, `Background Polling & Snapshot Fanout — P22`, `Architecture Decisions — harness-terminal`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `GPU Animation Pattern — Layout Once, GPU Paints`, `P10: Performance and Feature Roadmap (Terminal First, IDE Convenient)`, `.deepMerge`, `MCPServer`, `.handleCat`, `State`, `FormatStyledSegment.swift`, `RGBColor`, `Fixes Applied (v3.9.1+)`, `Consumers`, `SurfaceRegistryTests.swift`, `Tab`, `.encode`, `P13 — Embedded Browser Pane (cmux parity)`, `.install`, `Identifiable`, `.unlinkWindow`, `ThaiClusterRenderTests`, `NSTextField Leak in BoardViewController (P20 Performance)`, `SKILL-LOG.md`, `User Profile`, `UI Automation — Robot Framework (P18)`, `IPC Architecture`, `rust.json`, `HintModeOverlay`, `SixelDecoder`, `Bug — Cmd+\ sidebar toggle gone after collapse`, `LaunchdServiceInstaller`, `ThaiClusterCopyTests.swift`, `GroupedSessionDaemonTests`, `RawRepresentable`, `BlockContextMenuTests`, `Modifiers`, `.json`, `ReflowFastPathTests`, `HarnessOnboarding`, `.steps`, `Added`, `Changed`, `TabPillView`, `.json`, `ACP Client (Shelved)`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `Foundation` connect `Identifiable` to `Changelog Archive`, `graphify reference: extra exports and benchmark`, `.handleNormal`, `IPCRequest`, `AgentNotchRootView`, `Command`, `KittyKeyboardTests`, `VTParser`, `.applyPreedit`, `MetalRendererTests`, `HarnessChrome`, `SpecialKey`, `CopyModeAction`, `SplitPaneCoordinator`, `.request`, `WorktreeManager`, `RGBColor`, `.parse`, `Sendable`, `Task Ledger Archive (Tasks 1–50)`, `DaemonClient`, `String`, `.startWatching`, `[3.12.0] - 2026-06-30`, `HarnessSettings`, `HarnessSidebarPanelViewController.swift`, `CodingKeys`, `harness.resource`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `HookEvent`, `markPane`, `.keyEvent`, `.handleWake`, `BellScanState`, `PasteBufferStore`, `FrecencyDirectoryStore`, `HarnessCLI+Server.swift`, `.text`, `ShellIntegration`, `String`, `Completed Plans Archive`, `FileTreeKeyboardNavigator`, `.statusLineSet`, `OptionStore`, `.parse`, `Endpoint`, `KouenCLITests.swift`, `DaemonSubscription`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `SessionCoordinator`, `Zombie View Crashes on macOS 26.5 + Swift 6.3.2`, `code:bash (# Terminal 1: Create workspace with long-running job)`, `AttachInputBatcher`, `PaneContainerView`, `.dispatch`, `Session Grouping and Split Session Plan`, `DaemonLauncher`, `AnyCodable`, `Recipe`, `Changelog`, `domain-design.md`, `ScriptFileWatcher`, `AgentNotchViewModel`, `DamageTrackingTests`, `.resolve`, `BrowserResponsePayload`, `.makeSnapshot`, `.firstWaitingTab`, `.encode`, `ActiveTabCloseDisposition`, `PaneNode`, `WorkspaceFileTreeView`, `SessionGroup`, `ViEngine`, `HistoryRingBuffer`, `AgentHookInstaller`, `[3.10.1] - 2026-06-27`, `CommandTarget`, `.startWatching`, `ActivePaneService`, `User Story Mapping (MANDATORY)`, `PtyDrainCeilingBenchmark`, `graphify reference: query, path, explain`, `TerminalHostView`, `CopyModeGridSource`, `PaneStyleSet`, `AsciiFastPathTests`, `DecodedImage`, `FileTreeWatcher`, `TriState`, `EnvironmentStore`, `.evaluate`, `What You Must Do When Invoked`, `BrowserIntegrationController`, `Int`, `LiveResizeTests`, `[3.9.1] - 2026-06-22`, `MatchCategory`, `AmbientBackground`, `ColorKind`, `AgentKind`, `What You Must Do When Invoked`, `CommandPromptController`, `[2.1.0] - 2026-06-07`, `FilePreviewCoordinator`, `URLDetection`, `.decodeKeySpec`, `BoardCard`, `BlockSummary`, `.hold`, `Added`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `GridCompositorTests`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `user-stories.md`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `BinaryInstallerVersionTests`, `MCP Server (harness-mcp)`, `PaletteModel`, `TerminalProgressReport`, `ReplayStep`, `grok`, `PaneDropZoneOverlay`, `PaneTarget`, `.translate`, `CellColorResolverTests`, `ScrollbackFile`, `Prompt`, `Section`, `ReplayStep`, `TerminalServicesProvider`, `CellColorResolver`, `HarnessPathDisplay`, `FileChangeWatcher`, `sessionRow`, `.decide`, `HarnessGridTerminalTests`, `ExternalOpenKind`, `TerminalGridCellLayoutTests`, `P10 Task: Lazy Scrollback Reflow`, `.scan`, `graphify reference: incremental update and cluster-only`, `.make`, `.copySelection`, `PaneBorderStatus`, `TerminalMetalRenderer`, `.make`, `.renderFixture`, `ReflowPreviewTests`, `SessionCoordinator`, `BundledThemesData.swift`, `release-hotfix.sh`, `Sidebar SwiftUI Migration — Knowledge`, `ThemeFileServiceTests`, `.welcome`, `Browser Pane (P14)`, `.install`, `code:bash (# Old (agent-specific):)`, `SGRMouseEvent`, `[2.5.0] - 2026-06-12`, `.run`, `reorderSession`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `FormatColor`, `click_ui_element`, `After all done, come back and update agent-memory/memory.md and agent-memory/plans/p14-web-browser-pane.md.`, `JSONDecoder`, `Fixes Applied (layered)`, `.load`, `AgentApprovalBar`, `settings.json`, `jobs`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `ThemeDiagnostics`, `ViPathTokenTests`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `.unmarkText`, `code:bash (# In a Harness pane:)`, `FormatColor`, `DesktopNotifier`, `FloatingPaneController`, `.theme`, `ImmersivePalette.swift`, `.reopenClosedTab`, `ImageProtocolTests.swift`, `Foundation`, `Architecture Decisions — harness-terminal`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `MCPServer`, `.deepMerge`, `SurfaceProgressTracker`, `.handleCat`, `[3.5.1] - 2026-06-20`, `OcclusionTests`, `State`, `FormatStyledSegment.swift`, `SessionEditor.swift`, `generate-cheatsheet.js`, `[2.2.4] - 2026-06-11`, `Fixes Applied (v3.9.1+)`, `Tab`, `Git Panel`, `.encode`, `.run`, `ThaiClusterRenderTests`, `terminal_stress_runner.py`, `Darwin`, `UI Automation — Robot Framework (P18)`, `.load`, `Split Panes (NSSplitView)`, `AgentIconRenderer`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `Task 1: Redesign Session Sidebar`, `javascript.json`, `json.json`, `rust.json`, `.build`, `HintModeOverlay`, `SixelDecoder`, `Bug — Cmd+\ sidebar toggle gone after collapse`, `.delay`, `TaskDashboardView`, `Competitive Position (as of v3.12.0, 2026-07-02)`, `PathToken`, `LaunchdServiceInstaller`, `GroupedSessionDaemonTests`, `RawRepresentable`, `BlockContextMenuTests`, `main.swift`, `.encode`, `ReflowFastPathTests`, `HarnessOnboarding`, `.hitTest`, `Added`, `Service Decomposition — SessionCoordinator (P17)`, `.json`, `ACP Client (Shelved)`, `KittyGraphicsCommand`, `TabStatus`, `.panePathLookup`?**
