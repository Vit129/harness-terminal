...
## Corpus Check
- 782 files · ~819,432 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14784 nodes · 35057 edges · 3004 communities (896 shown, 2108 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 3952 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34d74e71`
...
1. `IPCRequest` - bridges 173 areas (192 edges)
2. `Command` - bridges 100 areas (107 edges)
3. `IPCResponse` - bridges 71 areas (94 edges)
4. `SessionCoordinator` - bridges 59 areas (131 edges)
5. `SurfaceRegistry` - bridges 58 areas (198 edges)
6. `KouenPaths` - bridges 57 areas (122 edges)
...
## Communities (3004 total, 2108 thin omitted)

### Community 0 - "CodingKey"
Cohesion: 0.09
Nodes (8): GitPanelView, .removeWorktreeAction(_:), .removeWorktreeAction(path:), Any, DispatchWorkItem, NSMenuItem, UnsafeMutableRawPointer, NSClickGestureRecognizer
...
Cohesion: 0.11
Nodes (11): .addSurface(tabID:paneID:), .addSurface(to:paneID:surfaceID:cwd:), .tab(containingPaneID:), .tab(forSurfaceKey:), .tabIndex(workspaceID:tabID:), Bool, Date, String (+3 more)
...
Cohesion: 0.10
Nodes (28): DaemonSubscription, .start(onData:onEnd:buffered:), .start(onResponse:onEnd:), Bool, Data, Int32, String, TimeInterval (+20 more)
...
Cohesion: 0.11
Nodes (17): OptionStore, OptionStore.Value, Scope, global, pane, session, workspace, ScopedKey (+9 more)
...
### Community 28 - ".parse"
Cohesion: 0.09
Nodes (15): Group, ParsedShortcut, PrefixCheatsheetWindow, PrefixIndicatorWindow, PrefixKeymap, Any, Bool, CGFloat (+7 more)
...
Cohesion: 0.04
Nodes (54): Error, CustomStringConvertible, Darwin, Error, ExpressibleByStringLiteral, Glibc, InstallError, unsupported (+46 more)

### Community 47 - ".normalizedKey"
Cohesion: 0.11
Nodes (14): Array, GroupHeaderRow, PickerItemRow, RecipePanel, RecipePickerController, RecipePickerFooter, RecipePickerView, RecipeWindowDelegate (+6 more)
...
Cohesion: 0.10
Nodes (13): SessionEditor, .tabIndex(surfaceID:), .tabIndex(surfaceKey:), SessionID, GroupedSessionTests, SessionGroup, Set, SurfaceID (+5 more)
...
Cohesion: 0.08
Nodes (21): SettingsTerminalView, Bool, String, TriState, auto, off, on, Typography (+13 more)
...
Cohesion: 0.08
Nodes (26): LSPClient, LSPClientError, missingPipe, processNotRunning, requestFailed, serverNotExecutable, FileHandle, Int32 (+18 more)
...
Cohesion: 0.14
Nodes (13): ChromeBackdrop, .init(role:), ChromeRole, sidebar, tabBar, KouenDesign, RuntimeGlassEffectView, Bool (+5 more)
...
Cohesion: 0.09
Nodes (20): HitTestPassthroughView, PaneContainerView, .init(node:cwd:themeName:existingHosts:existingBrowserPanes:), .init(paneID:), NSPoint, NSView, PaneID, PaneNode (+12 more)
...
Cohesion: 0.28
Nodes (15): Codable, BrowserElement, BrowserElementBounds, BrowserNetworkEntry, BrowserSnapshot, BufferSummary, HookEntry, IPCResponse (+7 more)
...
Cohesion: 0.10
Nodes (23): Int, Date, String, TerminalBlock, TerminalBlockStore, .block(atPromptLine:), .block(id:), .block(atPromptLine:) (+15 more)
...
Cohesion: 0.09
Nodes (24): AgentStatusDot, Context, AgentChipView, BoardColumnKind, Divider, FontSize, IconSize, KouenMotion (+16 more)
...
Cohesion: 0.08
Nodes (19): .init(coder:), .init(frame:), .init(coder:), Kind, primary, secondary, .init(coder:), KouenPillButton (+11 more)

### Community 197 - "AgentSessionSummary"
Cohesion: 0.10
Nodes (21): FlippedView, GitResult, HunkActionButton, .init(title:onClick:), Bool, NSButton, NSColor, NSEvent (+13 more)
...
Cohesion: 0.12
Nodes (7): CwdMetadataProvider, GitMetadataProvider, MetadataProvider, String, Tab, GitMetadataProviderTests, SessionSnapshot
...
Cohesion: 0.22
Nodes (7): BrowserProgressLine, .init(coder:), .init(frame:), Bool, Double, NSLayoutConstraint, NSRect
...
Cohesion: 0.07
Nodes (13): keys, CGImage, DecodedImage, ImageLimits, Bool, UInt8, ImageDecoder, Data (+5 more)
...
Cohesion: 0.10
Nodes (17): AppKit, Action, DesktopNotifier, KouenPathDisplay, NotificationPresenter, .userNotificationCenter(_:didReceive:withCompletionHandler:), .userNotificationCenter(_:willPresent:withCompletionHandler:), Bool (+9 more)
...
Cohesion: 0.23
Nodes (6): KouenCLI, SessionID, String, Bool, T, Void
...
Cohesion: 0.11
Nodes (20): CoreGraphics, CoreText, ImageIO, KouenCopyMode, KouenTerminalEngine, KouenTerminalRenderer, KouenTheme, Metal (+12 more)
...
Cohesion: 0.11
Nodes (11): KeybindingsService, Bool, Command, String, OptionSet, .init(from:), .init(key:modifiers:), Modifiers (+3 more)
...
### Community 374 - ".run"
Cohesion: 0.33
Nodes (3): ClosedRange, Range, .markRowsDirty(_:)
...
Cohesion: 0.09
Nodes (16): ConcurrentIndexSet, DaemonContentionTests, SubscriptionBox, String, URL, ShellLaunchProfileTests, SurfaceRegistryTests, .firstSurfaceID(for:in:) (+8 more)
...
Cohesion: 0.10
Nodes (21): Identifiable, View, CompleteStepView, Void, DiscoverStepView, Point, String, OnboardingStep (+13 more)

### Community 386 - "SKILL-LOG.md"
Cohesion: 0.09
Nodes (17): .webView(_:didCommit:), BrowserPaneViewTests, MockWebView, Any, Bool, CGFloat, CGPoint, Error (+9 more)
...
Cohesion: 0.09
Nodes (7): DataBox, KouenApp, GitPanelViewDiffErrorTests, String, GitPanelViewFSEventFilterTests, GitPanelViewToastErrorSummaryTests, GitPanelViewWorktreeParsingTests
...
Cohesion: 0.07
Nodes (16): .interval(_:_:), T, PendingMainHop, PresentAttempt, encodeFailure, nilDrawable, presented, SurfaceEmulatorState (+8 more)
...
Cohesion: 0.12
Nodes (13): .init(coder:), BrowserTabButton, .init(coder:), .init(title:isActive:onSelect:onClose:), DesignModePopoverViewController, .init(coder:), .init(title:properties:styles:onStyleChanged:onCopyCSS:), SelectAllOnClickTextField (+5 more)
...
Cohesion: 0.13
Nodes (13): .init(url:paneID:), .init(url:paneID:webView:), .webView(_:createWebViewWith:for:windowFeatures:), .webView(_:didFinish:), BrowserTab, URL, UUID, WKWebView (+5 more)
...
Cohesion: 0.06
Nodes (34): MainActor, NSButton, NSImage, Void, SessionDividerRowView, .init(coder:), SessionGroupHeaderRowView, .init(coder:) (+26 more)
...
Cohesion: 0.08
Nodes (13): String, WorkbenchMRU, Bool, String, ViEngine, Foundation, KouenCLI, KouenCore (+5 more)
...
Cohesion: 0.08
Nodes (19): NSCursor, KouenTerminalSurfaceView, .init(themeName:fontFamily:fontSize:vivid:colorRendering:colorGamut:offMainParserFramePipeline:liveResizeReflow:), .receive(_:), SurfaceColorProviderState, SurfaceFrameBuildConfiguration, CellColorResolver, CGFloat (+11 more)
...
Cohesion: 0.19
Nodes (10): .init(coder:), .init(frame:), .init(coder:), StageToggleButton, .init(coder:), .init(frame:), escaping, MainActor (+2 more)
...
Cohesion: 0.12
Nodes (15): InputGate, ReconnectLatch, Bool, CGFloat, FormatColor, KouenSettings, KouenTerminalSurfaceView, NSColor (+7 more)
...
Cohesion: 0.09
Nodes (19): CKouenSys, RealPty, .init(id:cwd:shell:rows:cols:scrollbackBytes:extraEnvironment:termProgram:termProgramVersion:scrollbackURL:), ScrollbackEntry, ScrollbackReplaySegment, ShellLaunchProfile, Bool, CChar (+11 more)
...
Cohesion: 0.10
Nodes (23): KeySpec, Binding, .init(from:), .init(spec:command:note:repeatable:), CodingKeys, bindings, disabledSpecs, id (+15 more)

## Knowledge Gaps
- **3048 isolated node(s):** `AppIntents`, `noActivePane`, `horizontal`, `vertical`, `unsupportedPlatform` (+3043 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **2108 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.
...
- **Why does `Int` connect `LiveResizeTests` to `Changelog Archive`, `CodingKey`, `graphify reference: extra exports and benchmark`, `callingPaneTarget`, `EngineConformanceTests`, `IPCRequest`, `AgentNotchRootView`, `LSPMessage`, `TerminalEmulator`, `PerformanceBenchmarks`, `GitPanelView.swift`, `KittyKeyboardTests`, `VTParser`, `HarnessTerminalSurfaceView`, `.applyPreedit`, `MetalRendererTests`, `HarnessUILibrary`, `SpecialKey`, `HarnessChrome`, `HarnessTerminalSurfaceView`, `CopyModeAction`, `SplitPaneCoordinator`, `.request`, `Harness tmux-style capabilities`, `SessionGroupHeaderRowView`, `.parse`, `RGBColor`, `Notification`, `Sendable`, `.addTab`, `Equatable`, `LegacySnapshot`, `MenuTarget`, `code:bash (harness chat "Use the project map first, then inspect this r)`, `String`, `.resolve`, `TerminalColorGamut`, `HarnessSettings`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `RenderSchedulerTests`, `harness.resource`, `.buildCommand`, `.normalizedKey`, `DaemonServer`, `.keyEvent`, `.handleWake`, `HarnessSplitView`, `TabCell`, `newWindow`, `BellScanState`, `CommandHistorySearchController`, `PasteBufferStore`, `ViEngine`, `FrecencyDirectoryStore`, `ComposedCell`, `HarnessCLI+Server.swift`, `.text`, `PrefixKeymap`, `String`, `worktree_isolation_cli.robot`, `XCTestCase`, `.parse`, `Endpoint`, `HarnessDesign`, `selectWorkspace`, `LSPClient`, `TerminalGridCell`, `HarnessPaths`, `.tomlKouenBlock`, `HarnessTerminalSurfaceView`, `TerminalModes`, `P2 — Async IPC Refactor: Design Document`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `Session Grouping and Split Session Plan`, `MainSplitViewController`, `DaemonLauncher`, `Recipe`, `Changelog`, `domain-design.md`, `AgentNotchViewModel`, `AnyCodable`, `DamageTrackingTests`, `SoftIconButton`, `[1.3.0-vit] - 2026-06-06`, `.makeSnapshot`, `[2.5.0] - 2026-06-12`, `HarnessGridTerminal`, `.firstWaitingTab`, `ViEngine`, `graphify reference: query, path, explain`, `WorkspaceFileTreeView`, `ViEngine`, `HistoryRingBuffer`, `.path`, `ClientSummary`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `SwiftUI`, `GlyphAtlas`, `.install`, `AgentHookInstaller`, `CommandTarget`, `.startWatching`, `ActivePaneService`, `User Story Mapping (MANDATORY)`, `PtyDrainCeilingBenchmark`, `CopyModeGridSource`, `PaneStyleSet`, `AsciiFastPathTests`, `MCPServer`, `.feedBuffer`, `What You Must Do When Invoked`, `Int`, `ThaiCombiningMarkTests`, `TerminalFindBar`, `Workspace`, `CommandPromptController`, `.jumpToBlock`, `FilePreviewCoordinator`, `URLDetection`, `.decodeKeySpec`, `BoardCard`, `[1.5.1] - 2026-06-06`, `BlockSummary`, `BinaryRefresherTests`, `.rects`, `InlineAICompletionView`, `Phase6KeysTests`, `.testOptionLinesAreNotCommands`, `[3.13.1] - 2026-07-02`, `P25 — iOS/iPadOS Support`, `VTConformanceCorpusTests`, `LSPServerRegistry`, `SessionSnapshot`, `Error`, `AppDelegate`, `GridCompositorTests`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `user-stories.md`, `ScriptRuntime`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `ResizeHUDView`, `AgentSessionSummary`, `.classify`, `MCP Server (harness-mcp)`, `[3.9.5] - 2026-06-26`, `HarnessCLI`, `scheduleRender`, `.testDataFrameEncodeVsJSONBase64Output`, `SettingsRemoteView`, `PaneTarget`, `CellColorResolverTests`, `GridCompositor`, `Prompt`, `TerminalServicesProvider`, `AgentNotchRowSummary`, `CellColorResolver`, `HarnessPathDisplay`, `ExternalOpenKind`, `TerminalGridCellLayoutTests`, `P10 Task: Lazy Scrollback Reflow`, `WorkbenchCommand`, `TerminalMetalRenderer`, `PaneBorderStatus`, `[3.5.1] - 2026-06-20`, `.make`, `ReflowPreviewTests`, `workspace`, `release-hotfix.sh`, `Sidebar SwiftUI Migration — Knowledge`, `WindowTitleStripView`, `listSurfaces`, `.welcome`, `.install`, `HarnessSidebarPanelViewController`, `.userNotificationCenter`, `.path`, `[2.2.4] - 2026-06-11`, `[3.11.2] - 2026-06-28`, `DefaultTerminalManager`, `StatusLineView.swift`, `WindowSession`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `renumberWindows`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `.rememberTabForReopen`, `FormatColor`, `click_ui_element`, `code:bash (harness-cli install-hooks hermes)`, `AgentHookStrategy`, `StatusLineWidthTests`, `Process`, `JSONDecoder`, `Fixes Applied (layered)`, `NotificationBus`, `settings.json`, `PaneNode`, `HarnessPaths.swift`, `.parse`, `00-inception-plan.md`, `.scrollWheel`, `FrameSignposter`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `Focus Persistence — Per-Session-Tab Pane Focus (RL-043)`, `UInt64`, `DesktopNotifier`, `LayoutNode`, `WorkspaceSymbolIndex`, `worktree_isolation.robot`, `.theme`, `ImmersivePalette.swift`, `.drawGlyph`, `.makeModel`, `Foundation`, `[2.2.3] - 2026-06-09`, `FileViewerViewController`, `Background Polling & Snapshot Fanout — P22`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `GPU Animation Pattern — Layout Once, GPU Paints`, `.handleCat`, `FormatStyledSegment.swift`, `[2.2.4] - 2026-06-11`, `Fixes Applied (v3.9.1+)`, `Consumers`, `DaemonStats`, `Git Panel`, `P13 — Embedded Browser Pane (cmux parity)`, `.run`, `ScrollReuseTests`, `.tabIndex(tabID:)`, `SurfaceProgressTrackerTests.swift`, `Task Ledger Archive (Tasks 1–50)`, `PromptQueue`, `NSTextField Leak in BoardViewController (P20 Performance)`, `User Profile`, `HarnessCLITests`, `AppKit + Metal Patterns`, `.load`, `AgentIconRenderer`, `main.swift`, `IPC Architecture`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `rust.json`, `HintModeOverlay`, `.parseDiffHunks`, `.delay`, `PathToken`, `Project History`, `.init`, `SessionEditor`, `RemoteHostStore`, `GroupedSessionDaemonTests`, `main.swift`, `PresentAttempt`, `RunState`, `.moveSelection`, `HarnessOnboarding`, `.hitTest`, `Added`, `ScrollbackTests`, `Command Prompt Architecture`, `.resolve`, `[3.10.1] - 2026-06-27`, `printThemePreview`, `requireSessionID`, `resolvedCLIPath`, `.json`, `graphify reference: extra exports and benchmark`, `.panePathLookup`?**
  _High betweenness centrality (0.291) - this node is a cross-community bridge._
- **Why does `Foundation` connect `ViEngine` to `Changelog Archive`, `.handleNormal`, `IPCRequest`, `Command`, `KittyKeyboardTests`, `VTParser`, `.applyPreedit`, `HarnessChrome`, `SpecialKey`, `code:block1 (Agent shell process)`, `ANSIPalette`, `SplitPaneCoordinator`, `.request`, `WorktreeManager`, `Harness tmux-style capabilities`, `CopyModeAction`, `RGBColor`, `.parse`, `Task Ledger Archive (Tasks 1–50)`, `Equatable`, `DaemonClient`, `String`, `HarnessSettings`, `CodingKeys`, `HarnessSidebarPanelViewController.swift`, `harness.resource`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `HookEvent`, `markPane`, `.keyEvent`, `.handleWake`, `HarnessSplitView`, `BellScanState`, `PasteBufferStore`, `FrecencyDirectoryStore`, `HarnessCLI+Server.swift`, `.text`, `ShellIntegration`, `.compose`, `FileTreeKeyboardNavigator`, `.statusLineSet`, `OptionStore`, `.parse`, `TerminalProtocolCompatibilityTests`, `Endpoint`, `KouenCLITests.swift`, `DaemonSubscription`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `.tomlKouenBlock`, `SessionCoordinator`, `Zombie View Crashes on macOS 26.5 + Swift 6.3.2`, `P2 — Async IPC Refactor: Design Document`, `AttachInputBatcher`, `PaneContainerView`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `DaemonLauncher`, `AnyCodable`, `Recipe`, `Changelog`, `ScriptFileWatcher`, `AgentNotchViewModel`, `.resolve`, `DamageTrackingTests`, `BrowserResponsePayload`, `.makeSnapshot`, `HarnessGridTerminal`, `.firstWaitingTab`, `ActiveTabCloseDisposition`, `SessionGroup`, `PaneNode`, `WorkspaceFileTreeView`, `ViEngine`, `Pipe`, `HistoryRingBuffer`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `AgentHookInstaller`, `[3.10.1] - 2026-06-27`, `CommandTarget`, `.startWatching`, `ActivePaneService`, `User Story Mapping (MANDATORY)`, `PtyDrainCeilingBenchmark`, `graphify reference: query, path, explain`, `TerminalHostView`, `CopyModeGridSource`, `PaneStyleSet`, `AsciiFastPathTests`, `DecodedImage`, `FileTreeWatcher`, `EnvironmentStore`, `.evaluate`, `BrowserIntegrationController`, `Int`, `LiveResizeTests`, `Harness Terminal — IDE Sidebar Feature Branch`, `[3.9.1] - 2026-06-22`, `AmbientBackground`, `ColorKind`, `MatchCategory`, `AgentKind`, `CommandPromptController`, `FilePreviewCoordinator`, `URLDetection`, `.decodeKeySpec`, `BlockSummary`, `.hold`, `InlineAICompletionView`, `[3.13.1] - 2026-07-02`, `GridCompositorTests`, `Error`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `user-stories.md`, `GlyphRasterizer`, `BinaryInstaller`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `BinaryInstallerVersionTests`, `MCP Server (harness-mcp)`, `PaletteModel`, `TerminalProgressReport`, `ReplayStep`, `grok`, `scheduleRender`, `PaneDropZoneOverlay`, `PaneTarget`, `.translate`, `CellColorResolverTests`, `Section`, `ReplayStep`, `AgentNotchRowSummary`, `TerminalServicesProvider`, `CellColorResolver`, `HarnessPathDisplay`, `FileChangeWatcher`, `sessionRow`, `.decide`, `HarnessGridTerminalTests`, `ExternalOpenKind`, `P10 Task: Lazy Scrollback Reflow`, `TerminalGridCellLayoutTests`, `.scan`, `graphify reference: incremental update and cluster-only`, `.make`, `.copySelection`, `PaneBorderStatus`, `TerminalMetalRenderer`, `.make`, `FileNode`, `.renderFixture`, `ReflowPreviewTests`, `HarnessTerminalSurfaceWorkerTests`, `BundledThemesData.swift`, `release-hotfix.sh`, `Sidebar SwiftUI Migration — Knowledge`, `WindowTitleStripView`, `.welcome`, `Browser Pane (P14)`, `.install`, `SGRMouseEvent`, `[2.5.0] - 2026-06-12`, `.run`, `reorderSession`, `DisplayPanesOverlay`, `.menu`, `TerminalScrollbarView`, `FormatColor`, `click_ui_element`, `After all done, come back and update agent-memory/memory.md and agent-memory/plans/p14-web-browser-pane.md.`, `JSONDecoder`, `Fixes Applied (layered)`, `.load`, `AgentApprovalBar`, `settings.json`, `jobs`, `HarnessPaths.swift`, `.parse`, `ThemeDiagnostics`, `ViPathTokenTests`, `AgentSnapshot`, `Terminal AI Chat (⌘I inline overlay)`, `.unmarkText`, `FormatColor`, `UInt64`, `DesktopNotifier`, `FloatingPaneController`, `.theme`, `.reopenClosedTab`, `.recordReapedGenerationForTesting`, `ImageProtocolTests.swift`, `CommandExecutionError`, `Foundation`, `code:bash (harness-cli install-hooks pi)`, `Architecture Decisions — harness-terminal`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `MCPServer`, `P10: Performance and Feature Roadmap (Terminal First, IDE Convenient)`, `.deepMerge`, `.handleCat`, `[3.5.1] - 2026-06-20`, `State`, `FormatStyledSegment.swift`, `SessionEditor.swift`, `generate-cheatsheet.js`, `[2.2.4] - 2026-06-11`, `Tab`, `.encode`, `Identifiable`, `MCPServer`, `ThaiClusterRenderTests`, `terminal_stress_runner.py`, `NSTextField Leak in BoardViewController (P20 Performance)`, `UI Automation — Robot Framework (P18)`, `.load`, `AgentIconRenderer`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `go.json`, `javascript.json`, `json.json`, `rust.json`, `HintModeOverlay`, `SixelDecoder`, `Bug — Cmd+\ sidebar toggle gone after collapse`, `.delay`, `Competitive Position (as of v3.12.0, 2026-07-02)`, `PathToken`, `LaunchdServiceInstaller`, `.init`, `GroupedSessionDaemonTests`, `RawRepresentable`, `BlockContextMenuTests`, `main.swift`, `.run`, `.encode`, `ReflowFastPathTests`, `PresentAttempt`, `HarnessOnboarding`, `.hitTest`, `Added`, `Service Decomposition — SessionCoordinator (P17)`, `.json`, `ACP Client (Shelved)`, `.panePathLookup`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `KouenCore` connect `ViEngine` to `Changelog Archive`, `.handleNormal`, `IPCRequest`, `AgentNotchRootView`, `Command`, `PerformanceBenchmarks`, `KittyKeyboardTests`, `HarnessTerminalSurfaceView`, `.applyPreedit`, `MetalRendererTests`, `HarnessUILibrary`, `SpecialKey`, `.text`, `code:block1 (Agent shell process)`, `.request`, `Harness tmux-style capabilities`, `SessionGroupHeaderRowView`, `.parse`, `install-app.sh`, `Sendable`, `Task Ledger Archive (Tasks 1–50)`, `Equatable`, `LegacySnapshot`, `NSObject`, `String`, `HarnessSettings`, `CodingKeys`, `RenderSchedulerTests`, `HarnessTerminalSurfaceView.swift`, `.buildCommand`, `.normalizedKey`, `HookEvent`, `DaemonServer`, `ScrollbackPersistenceTests`, `.keyEvent`, `.handleWake`, `HarnessSplitView`, `NSPanel`, `BellScanState`, `CommandHistorySearchController`, `3.2 สิ่งที่ implement แล้ว`, `ViEngine`, `HarnessCLI+Server.swift`, `.text`, `Completed Plans Archive`, `.compose`, `FileTreeKeyboardNavigator`, `worktree_isolation_cli.robot`, `XCTestCase`, `.statusLineSet`, `OptionStore`, `.parse`, `TerminalProtocolCompatibilityTests`, `Endpoint`, `HarnessDesign`, `KouenCLITests.swift`, `LSPClient`, `LSPDiagnostic`, `TerminalGridCell`, `.tomlKouenBlock`, `SessionCoordinator`, `Zombie View Crashes on macOS 26.5 + Swift 6.3.2`, `P2 — Async IPC Refactor: Design Document`, `AttachInputBatcher`, `shim.c`, `PaneContainerView`, `4. Technical Architecture`, `.dispatch`, `ScriptRuntime.swift`, `Session Grouping and Split Session Plan`, `Changelog`, `AgentNotchViewModel`, `.resolve`, `DamageTrackingTests`, `SoftIconButton`, `BrowserResponsePayload`, `.makeSnapshot`, `.encode`, `clearSelection`, `PaneNode`, `WorkspaceFileTreeView`, `SessionGroup`, `Pipe`, `String`, `code:block1 (SessionCoordinator.snapshot ──┐)`, `.install`, `.load`, `code:js (// ~/.config/harness/init.js)`, `stability_release.robot`, `PtyDrainCeilingBenchmark`, `ActivePaneService`, `User Story Mapping (MANDATORY)`, `.testPaneLeafLegacyDecodeBackfillsSurfaceTabs`, `DecodedImage`, `MCPServer`, `TriState`, `EnvironmentStore`, `New Tab`, `FileTreeWatcher`, `ThaiCombiningMarkTests`, `.recordReapedGenerationForTesting`, `Harness Terminal — IDE Sidebar Feature Branch`, `MatchCategory`, `AmbientBackground`, `sessionCreated`, `ActiveTabCloseDisposition`, `AgentTableEntry`, `ReflowCorpusTests`, `.decodeKeySpec`, `RGBColorTests`, `Added`, `BlockSummary`, `InlineAICompletionView`, `GridCompositorTests`, `TerminalScreen`, `P25 — iOS/iPadOS Support`, `AppDelegate`, `P5 — ACP (Agent Client Protocol) — Harness as ACP Editor/Client`, `ScriptRuntime`, `[2.3.0] - 2026-06-11`, `Tab Bar (TerminalTabBarView) — Layout, Git Branch & Drag`, `[2.5.1] - 2026-06-12`, `BinaryInstaller`, `AgentSessionSummary`, `.classify`, `FileTabManager`, `BinaryInstallerVersionTests`, `MCP Server (harness-mcp)`, `PaletteModel`, `AutomationScheduler`, `CopyModeState`, `PaneDropZoneOverlay`, `.translate`, `CellColorResolverTests`, `GridCompositor`, `Prompt`, `Section`, `HarnessPathDisplay`, `SSHTunnelManagerTests`, `sessionRow`, `graphify reference: incremental update and cluster-only`, `P10 Task: Lazy Scrollback Reflow`, `TerminalGridCellLayoutTests`, `.scan`, `WorkbenchCommand`, `TextGrid`, `p11_scripting.robot`, `.make`, `AgentBridge`, `.make`, `FileNode`, `.renderFixture`, `DaemonMetrics`, `ReflowPreviewTests`, `HarnessTerminalSurfaceWorkerTests`, `[3.4.0] - 2026-06-19`, `Split Right`, `Sidebar SwiftUI Migration — Knowledge`, `ThemeFileServiceTests`, `.welcome`, `Browser Pane (P14)`, `.install`, `KeySpec`, `[2.5.0] - 2026-06-12`, `SyntaxTextView`, `reorderSession`, `CLICommand`, `BlockTintOverlay`, `TerminalScrollbarView`, `code:bash (harness-cli install-hooks hermes)`, `.apply`, `.load`, `GitHubCLIClient`, `NotificationBus`, `jobs`, `PaneNode`, `ThemeDiagnostics`, `.encodeMouse`, `00-inception-plan.md`, `ViPathTokenTests`, `Send Ex Command`, `Terminal AI Chat (⌘I inline overlay)`, `FormatColor`, `.theme`, `ImmersivePalette.swift`, `.recordReapedGenerationForTesting`, `RealPty`, `ImageProtocolTests.swift`, `CommandExecutionError`, `CSIParams`, `Foundation`, `DaemonLifecycleTests`, `Background Polling & Snapshot Fanout — P22`, `Architecture Decisions — harness-terminal`, `Memory Leak Audit — 34 GB Long-Session Case (2026-06-26)`, `MCPServer`, `P10: Performance and Feature Roadmap (Terminal First, IDE Convenient)`, `.deepMerge`, `.handleCat`, `State`, `FormatStyledSegment.swift`, `RGBColor`, `generate-cheatsheet.js`, `Consumers`, `SurfaceRegistryTests.swift`, `Tab`, `.encode`, `DynamicInstanceBuffer`, `.install`, `Identifiable`, `PromptQueue`, `ThaiClusterRenderTests`, `NSTextField Leak in BoardViewController (P20 Performance)`, `SKILL-LOG.md`, `User Profile`, `UI Automation — Robot Framework (P18)`, `IPC Architecture`, `Session/Tab/Pane Hierarchy & Top Bar (CASE-028)`, `markdown.json`, `rust.json`, `yaml.json`, `FilePreviewCoordinatorTabScopeTests`, `HintModeOverlay`, `SixelDecoder`, `.delay`, `LaunchdServiceInstaller`, `WaitForRegistry`, `ThaiClusterCopyTests.swift`, `RawRepresentable`, `BlockContextMenuTests`, `Modifiers`, `.json`, `.run`, `ReflowFastPathTests`, `PresentAttempt`, `HarnessOnboarding`, `.steps`, `Added`, `Changed`, `.json`, `ACP Client (Shelved)`?**
