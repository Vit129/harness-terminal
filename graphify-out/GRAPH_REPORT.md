...
## Summary
- 6558 nodes · 12054 edges · 399 communities (208 shown, 191 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 1227 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4ad5a80c`
...
8. `main()` - 78 edges
9. `MetalRendererTests` - 75 edges
10. `SurfaceRegistry` - 75 edges
...
## Communities (399 total, 191 thin omitted)
...
Cohesion: 0.03
Nodes (69): InstallResult, Buffer, Configuration, CLICommand, CLICommandCatalog, Comparable, Equatable, PaneListRow (+61 more)
...
Cohesion: 0.03
Nodes (64): CaseIterable, Phase, daemonConnected, firstDrawablePresented, firstSnapshot, firstSurfaceAttached, firstWindow, launchStart (+56 more)
...
Cohesion: 0.04
Nodes (37): Codable, Hook, JSONOutputFormatterTests, ANSIPalette, HarnessThemeDefinition, Appearance, AppearanceKind, dark (+29 more)
...
Cohesion: 0.08
Nodes (6): FormatStringTests, OptionStoreTests, OptionStore, ScopedKey, HarnessOptions, StatusLineView
...
Cohesion: 0.09
Nodes (10): harness_open_pty_master(), harness_open_rdwr(), harness_peer_uid(), harness_pty_get_winsize(), harness_pty_make_controlling(), harness_pty_set_winsize(), harness_set_nonblocking(), RealPty (+2 more)
...
Cohesion: 0.05
Nodes (10): ControlKeyNormalizerTests, LaunchAgentInstallerTests, TerminalIdentityTests, RealPtyReplayTests, BinaryInstallerDisplayTests, CharacterWidthTests, TerminalGridCellLayoutTests, TerminalHostViewTests (+2 more)
...
Cohesion: 0.06
Nodes (32): Agent hooks, Build from source, code:bash (harness-cli list-surfaces), code:bash (xcodegen generate), code:bash (# From the built app:), code:bash (# On the remote box: run the daemon and note its socket path), code:bash (harness-cli install-hooks claude-code), code:bash (swift build) (+24 more)
...
Cohesion: 0.07
Nodes (30): TransportError, invalidContentLength, invalidUTF8Header, malformedHeader, missingContentLength, CommandExecutionError, daemonError, noActiveSurface (+22 more)
...
Cohesion: 0.08
Nodes (14): AgentConfig, AgentRegistryStore, FileNode, GitStatusType, added, deleted, modified, unmodified (+6 more)
...
Cohesion: 0.12
Nodes (5): NSControl, FlippedStackHost, HarnessSelect, HarnessSelectPopover, SelectRow
...
Cohesion: 0.09
Nodes (19): AgentActivity, awaiting, errored, idle, working, AgentKind, aider, claudeCode (+11 more)
...
Cohesion: 0.09
Nodes (22): IPCResponse, agentInfo, buffer, clientID, daemonStats, data, error, hookID (+14 more)
...
Cohesion: 0.14
Nodes (4): KeyTableTests, KeySpec, Modifiers, OptionSet
...
Cohesion: 0.18
Nodes (4): WorkspaceFileTreeView, NSMenuDelegate, NSOutlineViewDataSource, NSOutlineViewDelegate
...
Cohesion: 0.16
Nodes (3): DynamicInstanceBuffer, ImageTextureCache, buffers
...
Cohesion: 0.18
Nodes (8): BinaryInstaller, DetectionStatus, found, notFound, willInstall, InstallError, missingBundledTools, InstallReport
...
Cohesion: 0.32
Nodes (3): NSTableCellView, FileTreeCellView, FileTreeItem
...
Cohesion: 0.33
Nodes (5): [1.0.0] - 2026-06-05, Added, Changed, Changelog, Known Issues
...
## Knowledge Gaps
- **1054 isolated node(s):** `TTYSize`, `noSnapshot`, `unresolved`, `active`, `id` (+1049 more)
...
- **Why does `HarnessTerminalSurfaceView` connect `Community 14` to `Community 255`, `Community 7`, `Community 168`, `Community 80`, `Community 81`, `Community 49`, `Community 51`, `Community 341`, `Community 55`, `Community 127`, `Community 285`, `Community 286`, `Community 31`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `RemoteHost` connect `Community 184` to `Community 8`, `Community 0`, `Community 2`, `Community 66`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `LiveResizeTests` connect `Community 51` to `Community 27`?**
